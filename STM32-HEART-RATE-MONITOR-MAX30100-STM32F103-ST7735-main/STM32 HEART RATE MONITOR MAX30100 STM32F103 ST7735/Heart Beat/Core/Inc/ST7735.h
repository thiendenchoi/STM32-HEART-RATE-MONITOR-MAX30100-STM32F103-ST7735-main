...
#define LCD_RST1 HAL_GPIO_WritePin(GPIOC, GPIO_PIN_14,GPIO_PIN_SET)
#define LCD_RST0 HAL_GPIO_WritePin(GPIOC, GPIO_PIN_14,GPIO_PIN_RESET)

#define	LCD_DC1	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_15,GPIO_PIN_SET)
#define	LCD_DC0 HAL_GPIO_WritePin(GPIOC, GPIO_PIN_15,GPIO_PIN_RESET)

#define	LCD_CS1	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13,GPIO_PIN_SET);
#define	LCD_CS0	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13,GPIO_PIN_RESET);
